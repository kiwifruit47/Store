...
public class Main {
    public static void main(String[] args) {
        ...
        Product bread = new Product("Dobrudzha bread", new BigDecimal("0.9"), Category.FOOD, LocalDate.of(2025, 1, 12));
        Product chicken = new Product("Chicken", new BigDecimal("4.3"), Category.FOOD, LocalDate.of(2024, 12, 1));
        Product eggs = new Product("Eggs", new BigDecimal("3.8"), Category.FOOD, LocalDate.of(2024, 12, 17));
        ...
        Store store1 = new Store(markup1, 5, 30);
        ...
        store1.deliverNewProducts(bread, 30);
        store1.deliverNewProducts(chicken, 10);
        store1.deliverNewProducts(eggs, 15);
        store1.deliverNewProducts(toothBrush, 8);
        store1.deliverNewProducts(toothPaste, 12);
